...
<div>
  ...
  <div id="container">
    <div id="register">
      ...
      <input id="inputFields" type="text" placeholder="New Username" v-model="input.username">
      <input id="inputFields" type="password" v-model="input.password" placeholder="New password">
      <input id="btn" type="button" value="Register" v-on:click="register()">
      <input id="btn" type="button" value="Back to login" v-on:click="back()">
    </div>
  </div>
</div>
</template>
